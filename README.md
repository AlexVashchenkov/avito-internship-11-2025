...
components:
    ...
    UserToken:
        ...
        bearerFormat: JWT
```
2. При накатывании миграций выбрал утилиту `goose`, так как возникли большие проблемы с `golang-migrate`, для выполнения миграций через `docker-compose` установил её в сам образ и выполнил миграции с помощью отдельного сервиса в Docker.

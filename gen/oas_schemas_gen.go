...
// GetToken returns the value of Token.
func (s *UserToken) GetToken() string {
	return s.Token
}

// GetRoles returns the value of Roles.
func (s *UserToken) GetRoles() []string {
	return s.Roles
}

// SetToken sets the value of Token.
func (s *UserToken) SetToken(val string) {
	s.Token = val
}

// SetRoles sets the value of Roles.
func (s *UserToken) SetRoles(val []string) {
	s.Roles = val
}
...
type UsersSetIsActivePostNotFound ErrorResponse

func (*UsersSetIsActivePostNotFound) usersSetIsActivePostRes() {}
...
type UsersSetIsActivePostUnauthorized ErrorResponse

func (*UsersSetIsActivePostUnauthorized) usersSetIsActivePostRes() {}
